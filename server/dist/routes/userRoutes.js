...
import { getUsers, searchUsers, getUserById, createUser, updateUser, deleteUser, changePassword, } from "../controllers/userController.js";
...
router.get("/", authorize(UserRole.ADMIN, UserRole.SUPERUSER, UserRole.MODERATOR), getUsers);
