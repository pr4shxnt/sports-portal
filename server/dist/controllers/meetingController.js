...
export const createMeeting = async (req, res) => {
    try {
        const { title, topic, type, venue, roomNo, meetingLink, date, time, participants, // array of emails
         } = req.body;
        ...
        const users = await User.find({ email: { $in: participants } }).select("email name");
        const nameMap = {};
        users.forEach((u) => {
